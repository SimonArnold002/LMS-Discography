...
ZIP_NAME = "Discography.zip"
GITHUB_URL = "https://github.com/SimonArnold002/LMS-Discography"
# The version badge is read live from install.xml; the rest are static.
STATIC_BADGES = ["LMS 9.0.0+", "Material Skin", "MusicBrainz + Library + Streaming"]


def read_version(root):
    """Current plugin version from install.xml (the single source of truth)."""
    try:
        with open(os.path.join(root, "Discography", "install.xml"), encoding="utf-8") as f:
...
<title>Discography — LMS Plugin</title>
</head>
<body>
<p>Redirecting to <a href="README.html">the Discography page</a>…</p>
</body>
</html>
"""
